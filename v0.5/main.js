...
const T = {
  ar: {
    nav_home:"الرئيسية", nav_services:"الخدمات", nav_process:"طريقة العمل", nav_work:"الأعمال", nav_contact:"تواصل", nav_cta:"احجز استشارة",
    tagline:"ذكاء اصطناعي رشيق لأتمتة الأعمال",
    home_eyebrow:"وكالة ويب وذكاء اصطناعي — تونس",
    home_title_1:"نربط عملك", home_title_2:"بذكاء اصطناعي يشتغل بروحه",
    home_sub:"مواقع ويب، وكلاء ذكاء اصطناعي، وأنظمة أتمتة — كل نقطة في عملك تتصل بالأخرى، وتخدم بلا توقف.",
    home_cta1:"تكلم معانا على واتساب", home_cta2:"شوف الأعمال",
    home_s_tag:"الخدمات", home_s_title:"ثلاثة أنظمة، شبكة وحدة",
    s1_h:"مواقع ويب", s1_p:"موقع من الصفر يعكس هوية علامتك، سريع ومتجاوب.",
    s2_h:"وكلاء ذكاء اصطناعي", s2_p:"يجاوبو على الواتساب، الصوت، والمكالمات — 24/24.",
    s3_h:"أتمتة لأي workflow", s3_p:"وكيل ذكي لأي مهمة متكررة في عملك.",
    cta_title:"حاضر تربط عملك بالذكاء الاصطناعي؟",
    cta_p:"استشارة أولى مجانية — نتفرجو سوا على احتياجاتك.",
    cta_wa:"واتساب: 92 225 982", cta_fb:"صفحة فيسبوك Vokala AI",

    services_eyebrow:"الخدمات", services_h:"أنظمة مترابطة لعمل واحد",
    services_p:"كل خدمة نقطة في نفس الشبكة — نبنيوها باش تخدم مع بعضها، موش قطع منفصلة.",

    process_eyebrow:"طريقة العمل", process_h:"أربع مراحل، من الفكرة للإطلاق",
    process_p:"نفس الدقة اللي تتطلبها الأنظمة الميكانيكية، مطبقة على كل مشروع رقمي.",
    p1_h:"استكشاف", p1_p:"نفهموا نشاطك، جمهورك، والمشكلة اللي نحلوها.",
    p2_h:"تصميم", p2_p:"نبنيو هوية بصرية وتجربة استخدام خاصة بيك.",
    p3_h:"بناء", p3_p:"تطوير الموقع أو الوكيل، مع اختبار مستمر.",
    p4_h:"إطلاق ومتابعة", p4_p:"نشر، تدريب، وتحسين حسب الأداء.",

    work_eyebrow:"الأعمال", work_h:"حاجات بنيناها فعلاً", work_p:"نماذج ومشاريع قيد التطوير أو منجزة.",
    w1_h:"وكيل مبيعات ذكي للعقارات", w1_p:"منتج B2B — بحث عن العملاء والرد الآلي عليهم.", w1_s:"قيد التطوير",
    w2_h:"لوحة تحكم لـ ABDO Céramique", w2_p:"نظام متابعة داخلي لتسيير النشاط.", w2_s:"منجز",
    w3_h:"موقع سيرة ذاتية تفاعلي", w3_p:"موقع شخصي متحرك، ثنائي اللغة.", w3_s:"منشور",

    contact_eyebrow:"تواصل", contact_h:"نبداو نتكلمو؟", contact_p:"واتساب، فيسبوك، ولا مكالمة — كيفما يناسبك.",
    ...
    bot_welcome:"أهلا! أنا وكيل Vokala AI — جرّبني كيما تجرب وكيل حقيقي عند عملائك 👋",
    bot_fallback:"هذا السؤال يحتاج تفاصيل أكثر — نحبك نكمل معاك على واتساب مباشرة.",
    bot_cta_wa:"كمل على واتساب",
    bot_quick:[
      {k:"price", label:"شحال الأسعار؟", a:"المواقع تبدأ من 500 د.ت، ووكيل الذكاء الاصطناعي من 100 د.ت شهريًا. نعطيك عرض دقيق بعد ما نعرفو احتياجاتك."},
      {k:"lang", label:"يفهم بالدارجة؟", a:"إيه، الوكيل يفهم الدارجة التونسية، العربية الفصحى، والفرنسية."},
      {k:"time", label:"شحال ياخذ وقت؟", a:"أغلب المواقع تجهز في أسبوع لجوز، والوكيل الذكي في حدود أسبوعين."},
      {k:"what", label:"شنوة ينجم يعمل؟", a:"يجاوب على الواتساب، المكالمات، والرسائل الصوتية، ويتصل بأي نظام تخدم بيه."}
    ],
    bot_keywords:{
      price:["سعر","ثمن","فلوس","تكلفة","cout","prix"],
      lang:["لغة","دارجة","فرنسية","عربي"],
      time:["وقت","مدة","نهار","أسبوع"],
      what:["شنوة","وكيل","يعمل","خدمة"]
    }
  },
  en: {
